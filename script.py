...
def output_modifier(llm_response):
...
def input_modifier(prompt):
    ...
    if q[0] != "":
        ...
        if url != "":
            ...
            prompt = "Content of the following url : \n"+trim_to_x_words(text, MAX_EXTRACTED_TEXT)+"..."+prompt
    return now+"\n"+prompt
